...
export default function CatalogCard({stuffLink, commentaryLink='stub', title, description}: {stuffLink: String, commentaryLink: String, title: String, description: String}) {
  return (
